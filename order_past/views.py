...
def upload_files(request):
    ...
    conn = psycopg2.connect(host='localhost',dbname='dash_db',user='postgres',password='khouloud123',port='5432') 
    ...
    file_cclient =r'C:\Users\khouloud\Documents\PFE\data\order_past_input\CCCLIENT_'+format(current_year)+format(current_week)+'.txt'
    ...
    if cclient_exists == False:
        ...
        return render(request,'order_past\index.html',{'message_error':message_error}) 
...
def home(request):
    ...
    return render(request,'order_past/index.html',
    {
    'username':username,
